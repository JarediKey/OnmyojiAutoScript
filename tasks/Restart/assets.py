...
class RestartAssets:
	...
	I_MAIL_TOOLBAR = RuleImage(roi_front=(1137,18,35,29), roi_back=(1120,0,70,70), threshold=0.85, method="Template matching", file="./tasks/Restart/mail_entry/mail_toolbar.png")
