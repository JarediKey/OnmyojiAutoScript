...
class CostumeAssets: 
	...
	# Image Rule Assets
	# description 
	I_PET_HOUSE_13 = RuleImage(roi_front=(811,271,58,34), roi_back=(0,269,1280,37), threshold=0.8, method="Template matching", file="./tasks/Component/Costume/main13/main13_pet_house_13.png")
	# description 
	I_MAIN_GOTO_TOWN_13 = RuleImage(roi_front=(727,194,24,48), roi_back=(0,191,1280,54), threshold=0.8, method="Template matching", file="./tasks/Component/Costume/main13/main13_main_goto_town_13.png")
	# description 
	...
	# description 
	I_CHECK_MAIN_13 = RuleImage(roi_front=(806,273,64,31), roi_back=(0,273,1280,31), threshold=0.8, method="Template matching", file="./tasks/Component/Costume/main13/main13_check_main_13.png")
	# description 
	I_MAIN_GOTO_EXPLORATION_13 = RuleImage(roi_front=(561,133,24,45), roi_back=(0,125,1280,64), threshold=0.6, method="Template matching", file="./tasks/Component/Costume/main13/main13_main_goto_exploration_13.png")
